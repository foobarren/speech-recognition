prog: fft.o main.o frame.o split.o compare.o list.o wave.o 
	gcc -g -Wall -Wextra -o cpa fft.o frame.o list.o main.o compare.o split.o wave.o -lm -lpthread
list.o: list.c list.h frame.h fft.h
	gcc -g -Wall -Wextra -c -o list.o list.c
fft.o: fft.c fft.h
	gcc -g -Wall -Wextra -c -o fft.o fft.c
main.o: main.c fft.h split.h frame.h list.h  wave.h compare.h
	gcc -g -Wall -Wextra -c -o main.o main.c
split.o: split.c split.h fft.h wave.h frame.h
